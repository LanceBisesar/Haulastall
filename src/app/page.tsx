    ...
    <section className="py-20 sm:py-24 bg-surface relative pattern-overlay">
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image placeholder */}
          <div className="relative rounded-2xl overflow-hidden bg-primary/5 aspect-[4/3] flex items-center justify-center border border-surface-light">
            <div className="text-center p-8">
              ...
              <p className="text-muted text-sm">Luxury trailer exterior photo</p>
            </div>
          </div>
